...
public class CursoDAO implements InterfaceCursoDAO {
    ...
    public Curso buscarCursoPorCodigo(int cdCurso) {
        String sql = "SELECT cdCurso, nomeCurso FROM curso WHERE cdCurso = ?";
    ...
    public boolean editarCurso(Curso curso) {
        String sql = "UPDATE curso SET nomeCurso =? WHERE cdCurso = ?";
        ...
        try (
            ...
            stmt.setString(1, curso.getNomeCurso());
            stmt.setInt(2, curso.getCdCurso());
