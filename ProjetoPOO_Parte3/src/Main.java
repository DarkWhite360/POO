...
class Main{
    ...
    static String cpf, nome, dataNascimento, telefone, email, estado, cidade, endereco;
    ...
    public static Aluno cadastrarAluno(CursoController cursoController){
        ...
        Aluno aluno = new Aluno(cpf, nome, idade, dataNascimento, telefone , email , estadoCivil, estado, cidade, endereco, ra, curso, status);
